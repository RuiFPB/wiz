...
ifeq ($(WERR),0)
	...
	WERR_ := -Werror -Wno-error=unused-variable -Wno-error=unused-result -Wno-error=unused-parameter -Wno-error=unused-function -Wno-error=unused-value -Wno-error=ignored-attributes
else ifeq ($(WERR),2)
	WERR_ := -Werror
else
